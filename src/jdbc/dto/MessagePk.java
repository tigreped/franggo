...
/** 
 * This class represents the primary key of the MESSAGE table.
 */
public class MessagePk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof MessagePk)) {
			return false;
		}
		
		final MessagePk _cast = (MessagePk) _other;
		if (id != _cast.id) {
			return false;
		}
