...
/** 
 * This class represents the primary key of the CAMPAIGN table.
 */
public class CampaignPk implements Serializable
{
	 ...
	 * @param id
	 */
	public CampaignPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof CampaignPk)) {
			return false;
		}
		
		final CampaignPk _cast = (CampaignPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "jdbc.dto.CampaignPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
